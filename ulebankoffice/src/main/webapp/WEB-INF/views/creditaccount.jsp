...
<meta name="robots" content="index,follow">
      ...
      <meta property="og:title" content="<spring:message code='label.siteservice7' />" />
      <meta property="og:url" content="http://ulebank.unileon.es/creditaccount" />
      <meta property="og:description" content="<spring:message code='label.siteservice7description'/>"/>
				...
				<div class="row text-center intro-title">
					...
					<ul class="page-breadcrumb">
						...
						<li><span><spring:message
									code="label.siteservice7" /></span></li>
					</ul>
				</div>
			</div>
		</section>
									...
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-clock-o"></i> <input type="date"
												id="fechaApertura" name="fechaApertura" required="required" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
							...
							<div class="section-field col-md-12 register-form">
								<div class="row">
									...
									<label for="name"><spring:message code="label.s7c1"/>
										...
										<div class="field-widget">
											...
											<input type="text" id="descripcion-cero" value="<spring:message code='label.s7c7'/>"
											disabled="disabled" />
										</div>
									</div>
									
									<div class="section-field col-md-4">
									<label for="name"><spring:message code="label.s7c2"/></label>
									
										<div class="field-widget">
											<i class="fa fa-eur" ></i>
											<input type="text" id="importe-cero" value="0" disabled="disabled" />
										</div>
									</div>
									
									<div class="section-field col-md-4">
									<label for="name"><spring:message code="label.s7c3"/></label>
									
										<div class="field-widget">
											<i class="fa fa-calendar" ></i>
											<input type="date" id="fecha-cero" disabled="disabled" />
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<label for="name"><spring:message code="label.s7c1"/>
										...
										<div class="field-widget">
											<i class="fa fa-pencil" ></i>
											<input type="text" id="descripcion-uno" value="<spring:message code='label.s7c8'/>" disabled="disabled" />
										</div>
									</div>
									...
									<label for="name"><spring:message code="label.s7c2"/></label>
										...
										<div class="field-widget">
											<i class="fa fa-eur" ></i>
											<input type="text" id="importe-uno" value="0" disabled="disabled"/>
										</div>
									</div>
									...
									<label for="name"><spring:message code="label.s7c3"/></label>
										...
										<div class="field-widget">
											<i class="fa fa-calendar" ></i>
											<input type="date" id="fecha-uno" disabled="disabled" />
										</div>
									</div>
								</div>
								...
								<div id="moves-container">
									<div class="row">
										<div class="section-field col-md-4">
											<label for="movimientos[0].descripcionMovimiento"><spring:message code="label.s7c1"/></label>
										...
										<div class="section-field col-md-4">
											<label for="movimientos[0].importeMovimiento"><spring:message code="label.s7c2"/></label>
											<div class="field-widget">
											<i class="fa fa-eur" ></i>
										...
										<div class="section-field col-md-4">
											<label for="movimientos[0].fechaMovimiento"><spring:message code="label.s7c3"/></label>
											<div class="field-widget">
								...
								<p>
									<a role="button" id="add-moves"><spring:message code="label.addtransaction"/> <span
										class="fa fa-plus-square"></span></a>
								</p>

								<p>
									<a role="button" id="remove-moves"><spring:message code="label.removetransaction"/><span
											...
											<p class="modal-link last-element">
												<a href="#" data-toggle="modal"
													data-target="#modalExplicativo"> <spring:message
														code="label.whatiscreditaccount" /></a>
											</p>
										</div>
										
									<input type="submit" class="button mt-20" value="<spring:message code='label.calculate' />">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalExplicativoLabel"><spring:message code="label.credit"/></h4>
				</div>
				<div class="modal-body" style="text-align: justify;">
					<p><spring:message code="label.s7i10"/></p>
					<p><spring:message code="label.s7i11"/></p>
					<p><spring:message code="label.s7i12"/></p>
					<p><spring:message code="label.s7i13"/></p>
					<p><spring:message code="label.s7i14"/></p>
					<p><spring:message code="label.s7i15"/></p>
					<p><spring:message code="label.s7i16"/></p>
					<p><spring:message code="label.s7i17"/></p>
				</div>
