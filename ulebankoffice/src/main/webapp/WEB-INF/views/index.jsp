							...
							<div class="row">
								<div class="col-lg-12 col-md-12">
									...
									<ul class="menu-links">
										...
										<li class="page-scroll"><a href="#team"><spring:message
													code="label.ourteam" /></a></li>
										<li class="page-scroll"><a href="#sponsors"><spring:message
													code="label.sponsors" /></a></li>
										<li class="page-scroll"><a href="#links"><spring:message
													code="label.links" /></a></li>
										<li class="page-scroll"><a href="#contact"><spring:message
													code="label.contact" /><i
												class="fa fa-angle-down fa-indicator"></i></a> <!-- drop down multilevel  -->
											<ul class="drop-down-multilevel right-menu">
												<li><a href="/contact"><spring:message
															code="label.contactform" /></a></li>
											</ul></li>
										<li><a><spring:message code="label.language" />
												<i class="fa fa-angle-down fa-indicator"></i></a> <!-- drop down multilevel  -->
											<ul class="drop-down-multilevel right-menu">
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 text-center">
									<div class="slider-2">
										<span class="animated1"><spring:message
												code="label.welcometopmessage1" /></span>
										...
										<a href="#services" class="button animated8"> <span>
												<spring:message code="label.knowourservices" />
										</span></a> <a target="_blank" href="/contact"
											class="button button-black animated8"><span> <spring:message
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 text-center">
									<div class="slider-2">
										<span class="animated1"><spring:message
												code="label.welcometopmessage2" /></span>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 text-center">
									<div class="slider-2">
										<span class="animated1"><spring:message
												code="label.welcometopmessage3" /></span>
									...
									<div class="col-lg-6 col-md-6">
										<div class="custom-content">
											...
											<p>There are lots of reasons, but most importantly
												...
												perferendis ab! Ut, nulla, illo. Fugit rerum, nisi quo nam.</p>
											<ul class="mt-20">
												<li><i class="fa fa-hand-o-right"></i> Proin gravida
													nibh vel velit auctor aliquet. Aenean sollicitudin,</li>
												<li><i class="fa fa-hand-o-right"></i> lorem quis
													bibendum auctor, nisi elit consequat ipsum,</li>
												<li><i class="fa fa-hand-o-right"></i> nec sagittis sem
													nibh id elit. Duis sed odio sit amet nibh vulputate</li>
												<li><i class="fa fa-hand-o-right"></i> cursus a sit
													amet mauris. Morbi accumsan ipsum velit.</li>
												<li><i class="fa fa-hand-o-right"></i> cursus a sit
													amet mauris. Morbi accumsan ipsum velit.</li>
											</ul>
										</div>
									...
									<div class="col-lg-6 col-md-6">
										<div class="custom-content">
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing
												...
												debitis quaerat nesciunt, aliquam perferendis ab! Ut.</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="section-title-2 text-center">
								...
								<a target="blank" href="/offersconsulting"
									class="button-border-white"> <span><spring:message
											code="label.knowledgesubmit" /></span>
								</a>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 text-center">
						...
						<a class="button mt-50" href="/contact"> <span><spring:message
									code="label.contactways" /></span> <i class="fa fa-info"></i>
						</a> <a class="button button-white mt-50" target="blank"
							href="http://lawandfinanceule.blogspot.com.es/"> <span><spring:message
									code="label.ourblog" /></span> <i class="fa fa-eye"></i>
						</a>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-6 col-md-6">
						<div class="who-we-are-left">
							<h3 class="text-blue mb-20 text-center">
								<a href="https://www.unileon.es" target="_blank"><spring:message
										code="label.interestlink1" /></a>
							</h3>
							<h3 class="text-blue mb-20 text-center">
								<a href="http://www.economicas.unileon.es" target="_blank"><spring:message
										code="label.interestlink2" /></a>
							</h3>
							<h3 class="text-blue mb-20 text-center">
								<a href="http://www.imf.org/external/index.htm" target="_blank"><spring:message
										code="label.interestlink3" /></a>
							</h3>
							<h3 class="text-blue mb-20 text-center">
								<a href="http://www.bancomundial.org" target="_blank"><spring:message
										code="label.interestlink4" /></a>
							</h3>
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
						<div class="who-we-are-left">
							<h3 class="text-blue mb-20 text-center">
								<a href="http://lawandfinanceule.blogspot.com.es/"
									target="_blank"><spring:message code="label.interestlink5" /></a>
							</h3>
							<h3 class="text-blue mb-20 text-center">
								<a href="http://www.bde.es/bde/es/" target="_blank"><spring:message
										code="label.interestlink6" /></a>
							</h3>
							<h3 class="text-blue mb-20 text-center">
								<a href="https://www.ecb.europa.eu/home/html/index.en.html"
									target="_blank"><spring:message code="label.interestlink7" /></a>
							</h3>
							<h3 class="text-blue mb-20 text-center">
								<a href="http://www.mineco.gob.es/portal/site/mineco/"
									target="_blank"><spring:message code="label.interestlink8" /></a>
							</h3>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="section-title text-center">
						...
						<h1 class="text-red">
							<a href="/contact"><spring:message code="label.contactform" /></a>
						</h1>
					</div>
				</div>
			</div>
						...
						<div class="get-in-touch footer-hedding">
							...
							<div class="contact-add">
								...
								<p class="mt-15 mb-15 text-white">
									rraduc00@estudiantes.unileon.es</p>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6">
