...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Simulador de préstamos por el método Francés.">
        <meta name="keywords" content="ULe-Bank, simulador, calculos, prestamo, metodo, frances">
        ...
        <title>Préstamo método Francés</title>
                    ...
                    datasets: [
                        {
                            ...
                            data: [6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000]
                        },
                        {
                            label: "Intereses",
        ...
        <main class="general-class">
        	...
        	<div class="container">
                ...
                <div class="page-header">
  					<h1>Préstamo francés de cuota constante</h1>
				</div>

				<form:form role="form" method="post" modelAttribute="prestamoFrancesCuotaConstante">
					<div class="row">
						<div class="col-md-4">
				...
				<div class="bg-info">
                    <h3><c:out value="${model.resultadoPorPeriodo}"/></h3>
                    <h3><c:out value="${model.resultadoTotal}"/></h3>
                </div>
                
                <p class="modal-link last-element"><a href="#" onclick="drawChart()" data-toggle="modal" data-target="#modalExplicativo">¿Qué un préstamo por el método Francés?</a></p>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modalExplicativoLabel">Préstamo método Francés</h4>
                    </div>
                    <div class="modal-body">
                    	<p>En este sistema el capital se amortiza de forma
						creciente siendo los intereses decrecientes cuota a cuota al ser menor el capital vivo,
						de tal manera que en cada periodo la cuota conjunta por capital e intereses es idéntica
						a la del resto de los periodos.</p>
