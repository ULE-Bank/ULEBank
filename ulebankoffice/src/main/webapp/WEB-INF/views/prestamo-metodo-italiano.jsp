...
<html>
    ...
    <head>
        ...
        <meta name="description" content="Simulador de préstamo método Italiano.">
        <meta name="keywords" content="ULe-Bank, simulador, calculos, prestamo, metodo, italiano">
        ...
        <title>Préstamo método Italiano</title>
        ...
        <main class="general-class">
        	...
        	<div class="container">
                ...
                <div class="page-header">
  					<h1>Préstamo método Italiano</h1>
				</div>

				<form:form role="form" method="post" modelAttribute="prestamoMetodoItaliano">
					<div class="row">
						<div class="col-md-4">
				...
				<p class="modal-link last-element"><a href="#" onclick="drawChart()" data-toggle="modal" data-target="#modalExplicativo">¿Qué un préstamo por el método Italiano?</a></p>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modalExplicativoLabel">Préstamo método Italiano</h4>
                    </div>
                    <div class="modal-body">
                        <p>En esta modalidad el
						préstamo se amortiza por partes alícuotas en cada periodo, liquidándose los intereses
						por el capital pendiente correspondiente, por lo que las sucesivas cuotas son
						decrecientes al ser los intereses, período a período, menores.</p>
