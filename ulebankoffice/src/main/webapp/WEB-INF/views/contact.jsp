...
<title>The Corps — Responsive Multi-purpose HTML5 Template</title>
                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid-col-3">
                            <ul>
                              ...
                              <li class="active"><a href="contact-3.html">contact 3 </a></li>
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
      <div class="section-title-1 text-center">
        <h1 class="text-blue">Contact Information</h1>
   ...
   <div class="container-fluid">
    ...
    <div class="col-lg-6 col-md-6">
       <div class="contact-map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.8351288872545!2d144.9556518!3d-37.8173306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d4c2b349649%3A0xb6899234e561db11!2sEnvato!5e0!3m2!1sen!2sin!4v1443621171568" width="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
   </div>       
  </div>
  <div class="col-lg-6 col-md-6"> 
...
news-letter  -->
 ...
 <section class="news-letter white-bg">
  <div class="container">
     <div class="row">
        <div class="col-lg-6 col-md-6">
  ...
  <div class="row">
    <div class="col-lg-3 col-md-6 col-sm-6">
      ...
      <ul class="addresss-info"> 
        ...
        <li><i class="fa fa-envelope-o"></i>support@thecorps.com</li>
      </ul>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6">
