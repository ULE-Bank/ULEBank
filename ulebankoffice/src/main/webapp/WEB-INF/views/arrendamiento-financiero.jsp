...
<title><spring:message code="label.siteservice2"/></title>
			...
			<div class="container">
				<div class="row text-center intro-title">
					...
					<ul class="page-breadcrumb">
						...
						<li><span><spring:message code="label.siteservice2" /></span>
						</li>
					</ul>
				</div>
			</div>
							...
							<div id="register-form" class="register-form">
								<div class="row">
									<div class="section-field col-md-6">
										<label for="name"><spring:message code="label.valueofproperty"/>:</label>
									</div>
								</div>
								<div class="row">
									<div class="section-field col-md-6">
								...
								<div class="row">
									<div class="section-field col-md-6">
										<label for="name"><spring:message code="label.contractduration"/>:</label>
									</div>
								</div>
								<div class="row">
									<div class="section-field col-md-6">
								...
								<div class="row">
									<div class="section-field col-md-6">
										<label for="name"><spring:message code="label.sharepayment"/>:</label>
									</div>
								</div>
								<div class="row">
									<div class="section-field col-md-6">
										...
										<div class="row text-center intro-title">
											<p class="modal-link last-element">
												<a href="" data-toggle="modal"
													data-target="#modalExplicativo"><spring:message code="label.whatisleasing"/></a>
											</p>
										</div>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="modalExplicativoLabel"><spring:message code="label.siteservice2"/></h4>
					</div>
					<div class="modal-body">
						<p><spring:message code="label.s2i1"/></p>

						<br>

						<p><spring:message code="label.s2i2"/></p>

						<br>

						<ul>
							<li><spring:message code="label.s2i3"/></li>
							<li><spring:message code="label.s2i4"/></li>
							<li><spring:message code="label.s2i5"/></li>
							<li><spring:message code="label.s2i6"/></li>
							<li><spring:message code="label.s2i7"/></li>
							<li><spring:message code="label.s2i8"/></li>
						</ul>
					</div>
